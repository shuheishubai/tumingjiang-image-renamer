...
assert.match(js, /const MAX_PHOTOS_PER_PERSON=2/);
assert.match(js, /photos\.length<1\|\|photos\.length>MAX_PHOTOS_PER_PERSON/);
assert.doesNotMatch(js, /invalidPhotoNumbers/);
